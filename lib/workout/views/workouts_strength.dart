  ...
  Widget build(BuildContext context) {
    ...
    return new StoreConnector<AppState, Map>(
      ...
      converter: (Store<AppState> store) {
        ...
        returnObject["strengthPushPullWorkouts"] = store.state.workoutState.strengthPushPullWorkouts;
        returnObject["strengthLiftingCarryingWorkouts"] = store.state.workoutState.strengthLiftingCarryingWorkouts;
        returnObject["strengthGrand2StandWorkouts"] = store.state.workoutState.strengthGrand2StandWorkouts;
        returnObject["strengthRotationalStrengthWorkouts"] = store.state.workoutState.strengthRotationalStrengthWorkouts;
        returnObject["strengthKidsFitWorkouts"] = store.state.workoutState.strengthKidsFitWorkouts;
        returnObject["strengthWorkFitWorkouts"] = store.state.workoutState.strengthWorkFitWorkouts;        
        returnObject["strengthPushPullPaginateInfo"] = store.state.workoutState.strengthPushPullPaginateInfo;
        returnObject["strengthLiftingCarryingPaginateInfo"] = store.state.workoutState.strengthLiftingCarryingPaginateInfo;
        returnObject["strengthGrand2StandPaginateInfo"] = store.state.workoutState.strengthGrand2StandPaginateInfo;
        returnObject["strengthRotationalStrengthPaginateInfo"] = store.state.workoutState.strengthRotationalStrengthPaginateInfo;
        returnObject["strengthKidsFitPaginateInfo"] = store.state.workoutState.strengthKidsFitPaginateInfo;
        returnObject["strengthWorkFitPaginateInfo"] = store.state.workoutState.strengthWorkFitPaginateInfo;        
