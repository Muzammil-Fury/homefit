  ...
  Widget build(BuildContext context) {
    ...
    return new StoreConnector<AppState, Map>(
      ...
      converter: (Store<AppState> store) {
        ...
        returnObject["mobilityWorkouts"] = store.state.workoutState.mobilityWorkouts;
        returnObject["strengthWorkouts"] = store.state.workoutState.strengthWorkouts;
        returnObject["metabolicWorkouts"] = store.state.workoutState.metabolicWorkouts;
        returnObject["powerWorkouts"] = store.state.workoutState.powerWorkouts;
        returnObject["mobilityWorkoutsPaginateInfo"] = store.state.workoutState.mobilityWorkoutsPaginateInfo;
        returnObject["strengthWorkoutsPaginateInfo"] = store.state.workoutState.strengthWorkoutsPaginateInfo;
        returnObject["metabolicWorkoutsPaginateInfo"] = store.state.workoutState.metabolicWorkoutsPaginateInfo;
        returnObject["powerWorkoutsPaginateInfo"] = store.state.workoutState.powerWorkoutsPaginateInfo;
